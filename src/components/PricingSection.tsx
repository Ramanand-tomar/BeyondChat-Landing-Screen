...
const plans = [
  {
    name: "Starter",
    price: "49",
    description: "Perfect for small teams getting started with AI video calls.",
    features: [
      "100 video call hours/month",
  ...
  },
  {
    name: "Professional",
    price: "149",
    description: "For growing businesses that need advanced video features.",
    features: [
      "500 video call hours/month",
